...
private fun convertPasswordPolicyFailToAppError(
    passwordPolicyValidatorFail: PasswordPolicyValidatorResult.Fail
): SecurityError.PasswordTooWeak {
    ...
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_TOO_SHORT] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.TOO_SHORT)
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_NO_LETTER] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.NO_LETTER)
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_NO_UPPERCASE] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.NO_UPPERCASE)
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_NO_LOWERCASE] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.NO_LOWERCASE)
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_NO_DIGIT] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.NO_DIGIT)
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_NO_SPECIAL_CHAR] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.NO_SPECIAL_CHAR)
    errorArgs[SecurityErrorArgs.PASSWORD_FAIL_TOO_COMMON] =
        passwordPolicyValidatorFail.reasons.contains(PasswordPolicyFailReason.TOO_COMMON)
