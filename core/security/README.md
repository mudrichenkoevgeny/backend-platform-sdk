...
Security primitives for SDK-based applications: password hashing, MFA management, TOTP processing, and symmetric encryption. **HTTP routes and security “API” use cases** live in **`feature/user`**, not in this module.
