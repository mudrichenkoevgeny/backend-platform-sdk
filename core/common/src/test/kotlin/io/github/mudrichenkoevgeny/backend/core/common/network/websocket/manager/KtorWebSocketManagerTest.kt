...
class KtorWebSocketManagerTest {
    ...
    fun `handleSocketError logs correct appError for ValidationException`() {
        ...
        val validationException = io.github.mudrichenkoevgeny.backend.core.common.validation.ValidationException(validationError)
    ...
    fun `handleSocketError logs InvalidJsonBody for SerializationException`() {
        ...
        val serializationException = kotlinx.serialization.SerializationException(message)
