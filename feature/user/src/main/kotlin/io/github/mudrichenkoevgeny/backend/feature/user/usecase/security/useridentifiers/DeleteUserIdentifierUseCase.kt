...
class DeleteUserIdentifierUseCase @Inject constructor(
    ...
    suspend fun execute(
        ...
        val auditMetadata = mapOf(UserAuditMetadata.Keys.USER_IDENTIFIER_ID to userIdentifierId.asHexDashString())

        val rateLimiterEnforcerResult = rateLimiterEnforcer.enforce(
            requestContext = requestContext,
            rateLimitAction = RateLimitAction.USER_IDENTIFIER_CHANGE,
            rateLimitIdentifier = userIdentifierId.asHexDashString(),
