...
@Singleton
class UnlockByEmailUseCase @Inject constructor(
     ...
     * - Verifies the confirmation code via [OtpService] with [UserOtpVerificationType.EMAIL_UNLOCK].
     *
     * **Workflow:**
     ...
     * 4. Resolves the email identifier via [IdentifierManager].
     ...
     *
     * @param email Email address of the locked account.
     * @param confirmationCode Verification code received via email.
