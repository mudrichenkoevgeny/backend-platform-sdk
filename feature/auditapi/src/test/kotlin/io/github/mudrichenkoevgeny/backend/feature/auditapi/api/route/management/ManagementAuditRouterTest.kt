package io.github.mudrichenkoevgeny.backend.feature.auditapi.api.route.management
...
class ManagementAuditRouterTest : BaseRouterTest() {
    ...
    fun `get audit events - success with empty list`() = testApplication {
        ...
        val emptyPagedResult = PagedResult(
            items = emptyList<io.github.mudrichenkoevgeny.shared.foundation.core.audit.domain.model.event.AuditEvent>(),
            totalCount = 0,
            pageNumber = 1,
            pageSize = 10,
            totalPages = 0
