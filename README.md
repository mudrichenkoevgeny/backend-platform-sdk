...
```
implementation(platform("io.github.mudrichenkoevgeny:backend-platform-sdk-bom:0.0.8"))
...
// Or if you don't want to use BOM:
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-common:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-audit:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-crosscutting:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-database:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-events:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-observability:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-settings:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-security:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-core-storage:0.0.8")
implementation("io.github.mudrichenkoevgeny:backend-platform-sdk-feature-user:0.0.8")
```
